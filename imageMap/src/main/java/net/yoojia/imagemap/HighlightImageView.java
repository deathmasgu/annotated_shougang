...
public class HighlightImageView extends TouchImageView implements ShapeExtension {
	...
	public HighlightImageView(Context context,float newNum) {
		this(context,null,newNum);
	}

	public HighlightImageView(Context context, AttributeSet attrs,float newNum) {
		super(context, attrs,newNum);
	}
...
//    @Override
//   	protected void postScale(float scaleFactor) {
//   		// TODO Auto-generated method stub
//   		super.postScale(scaleFactor);
//   		if(scaleFactor != 0){
//               for(Shape shape : shapesCache.values()){
//                   if(scaleFactor != 0){
//                   	float num=viewWidth/bmWidth;
//                       float num1=(viewHeight-80)/bmHeight;
//                       float num_min;
//                       if(num>=num1){
//                       	num_min=num1;
//                       }else{
